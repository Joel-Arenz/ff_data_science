...
def main():
    ...
    df_ind_lstm_test, scaler_ind_lstm_pred, le_ind_lstm_pred = prepare_ind_data_for_lstm_prediction_and_outcome(df_ind_lstm_seq)
    ...
    df_sys_lstm_test, scaler_sys_lstm_pred, le_sys_lstm_pred = prepare_sys_data_for_lstm_prediction_and_outcome(df_sys_lstm_seq)
    ...
    lstm_approaches = {
        'individual': (X_ind_lstm, y_ind_lstm, X_train_ind_lstm, X_test_ind_lstm, y_train_ind_lstm, y_test_ind_lstm, scaler_ind_lstm_train, le_ind_lstm_train, df_ind_lstm_test, scaler_ind_lstm_pred, le_ind_lstm_pred, predict_2024_season_for_ind_lstm),
        'systematic': (X_sys_lstm, y_sys_lstm, X_train_sys_lstm, X_test_sys_lstm, y_train_sys_lstm, y_test_sys_lstm, scaler_sys_lstm_train, le_sys_lstm_train, df_sys_lstm_test, scaler_sys_lstm_pred, le_sys_lstm_pred, predict_2024_season_for_sys_lstm)
    }

    for approach_name, (X_lstm, y_lstm, X_train_lstm, X_test_lstm, y_train_lstm, y_test_lstm, scaler_lstm_train, le_lstm_train, df_lstm_test, scaler_lstm_pred, le_lstm_pred, predict_2024_season) in lstm_approaches.items():
